...
CREATE TABLE members (
    ...
    payment_due DECIMAL(6, 2) DEFAULT 0 NOT NULL
);
...
('amely_18', 'loseweightin18', 'Amely.Bauch91@yahoo.com', '2018-02-16 16:48:43', 0),
('bbahringer', 'iambeau17', 'Beulah_Bahringer@yahoo.com', '2017-12-28 05:36:50', 0),
...
FROM bookings JOIN rooms ON bookings.room_id = rooms.id ORDER BY bookings.id;
...
BEGIN
	SELECT * FROM rooms WHERE room_type = p_room_type AND id NOT IN
...
BEGIN
    ...
    IF CURDATE() >= v_booked_date THEN
		SELECT 'Cancellation cannot be done on and after the booked date' INTO p_message;
		...
		ELSE
            ...
            UPDATE members SET v_payment_due = v_payment_due - v_price;
...
BEGIN
    ...
    DECLARE cur CURSOR FOR
		...
		(SELECT member_id FROM bookings WHERE id = p_booking_id) ORDER BY datetime_of_booking DESC;
